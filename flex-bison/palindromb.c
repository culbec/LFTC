...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_MIDDLE = 4,                     /* MIDDLE  */
  YYSYMBOL_YYACCEPT = 5,                   /* $accept  */
  YYSYMBOL_input = 6,                      /* input  */
  YYSYMBOL_sentence = 7                    /* sentence  */
};
...
{
  "\"end of file\"", "error", "\"invalid token\"", "CHAR", "MIDDLE",
  "$accept", "input", "sentence", YY_NULLPTR
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 2: /* input: sentence  */
#line 50 ".\\palindromb.y"
                { 
    if (!middle_found) {
...
#line 1094 "palindromb.c"
    break;

  case 4: /* sentence: sentence CHAR  */
#line 67 ".\\palindromb.y"
                    {
        if (middle_found) {
            second_half[len_second_half++] = (yyvsp[0].c);
        } else {
            first_half[len_first_half++] = (yyvsp[0].c);
        }
        printf("Added char: %c\n", (yyvsp[0].c));
    }
#line 1107 "palindromb.c"
    break;

  case 5: /* sentence: sentence MIDDLE  */
#line 75 ".\\palindromb.y"
                      {
        middle_found = 1;
        printf("Middle marker found\n");
    }
#line 1116 "palindromb.c"
    break;


#line 1120 "palindromb.c"
